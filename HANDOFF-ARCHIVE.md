# HANDOFF archive: sections 1 through 28

Everything decided or discovered from the project's start through 21 Aug 2026,
before the log switched from numbered sections to dated headings. Numbering
collided twice and got renumbered by hand, which is the reason for the switch;
see the live `HANDOFF.md` for why.

This is history, not a to-do list. If something here still matters day to day,
it has already been carried forward into `AGENTS.md` or restated in the live
`HANDOFF.md`. Read this file only when you need to know how a past decision
was reached, not to find out what is true right now.
