...
function AccessGate({ view, signIn }: { view: string; signIn: () => void }) {
  const label: Record<string, string> = { home: 'Your weekly brief', events: 'The calendar', leaderboard: 'The leaderboard', profile: 'Your service record', stores: 'Your Shillings', admin: 'Staff command', roster: 'The roster' };
